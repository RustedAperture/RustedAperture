...
export default function Social() {
    return (
        <div className="xl:sticky top-[346px] xl:max-w-[50rem] max-xl:self-stretch drop-shadow-md flex flex-row flex-wrap items-stretch justify-center ml-1.5 mr-1.5">
            <a
                className="min-w-[48px] text-3xl text-center text-zinc-900 p-3 m-0.5"
            ...
            <a
                className="min-w-[48px] text-3xl text-center text-sky-500 p-3 m-0.5"
            ...
            <a
                className="min-w-[48px] text-3xl text-center text-gray-600 dark:text-gray-300 p-3 m-0.5"
            ...
            <a
                className="min-w-[48px] text-3xl text-center text-blue-500 p-3 m-0.5"
