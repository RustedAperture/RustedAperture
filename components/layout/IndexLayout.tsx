...
export default function IndexLayout() {
    return (
        <>
            <div className='grow flex flex-col self-stretch items-center'>
                <header className="xl:max-w-[60rem] grow xl:sticky top-8 max-xl:self-stretch drop-shadow-md flex flex-col flex-wrap justify-between items-stretch bg-white dark:bg-zinc-800 rounded-lg p-6 m-2">
