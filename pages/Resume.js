  ...
  return (
    <>
        ...
        <div id="top" className="gap-y-8 xl:sticky top-8 max-xl:self-stretch drop-shadow-md flex flex-row flex-wrap xl:flex-col items-stretch sm:min-w-[20rem] bg-white dark:bg-zinc-800 rounded-lg p-6 m-2">
            <div>
                <p>Self-motivated and results-oriented IT professional with a proven track record of success in event and product support, programming, and Linux/Unix system administration. Fast learner with a passion for new challenges and a commitment to continuous improvement. Expertise in supporting operations teams to achieve their goals.</p>
            </div>
            ...
            <div className="flex flex-col gap-y-4">
                ...
                <div>
                    ...
                    <p>Givergy</p>
                    <p>Event delivery and support for North American on-site staff, ensuring a smooth event process. Platform quality assurance through testing and bug coordination with the development team.</p>
                </div>
                <div>
                    ...
                    <p>Givergy</p>
                    <p>Provide global technical support for a SaaS product, managing and prioritizing customer cases and tickets from Hong Kong, Australia, North America, and the UK.</p>
                </div>
                <div>
